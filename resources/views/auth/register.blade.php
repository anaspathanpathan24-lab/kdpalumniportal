                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" required class="w-full border-b border-gray-300 py-1.5 text-gray-900 focus:outline-none focus:border-[#8b0000] bg-transparent text-[15px] transition-colors">
                            @error('password') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label class="block text-[13px] text-gray-600 mb-1">Confirm Password *</label>
                            <input type="password" name="password_confirmation" required class="w-full border-b border-gray-300 py-1.5 text-gray-900 focus:outline-none focus:border-[#8b0000] bg-transparent text-[15px] transition-colors">
                        </div>
